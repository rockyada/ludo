											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														<a href="<?php echo e(route($model.'.edit',base64_encode($record->id))); ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Edit">
														...
														<a href="<?php echo e(route($model.'.delete',base64_encode($record->id))); ?>" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Delete">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>