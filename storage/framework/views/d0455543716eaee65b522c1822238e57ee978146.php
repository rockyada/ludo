            ...
            <form class="login_form_box" id="profile_image_uploads" enctype="multipart/form-data">
                <div class="upload_imgBox">
                    <div class="upload-img">
                        <img src="<?php echo e(Login()->image != '' ? Config('constants.USER_IMAGE_ROOT_PATH').Login()->image : asset('public/frontend/custom/img/avatar.svg')); ?>" alt="">
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="profile_editeBtn">
                                <input type="text" class="form-control nameShow" disabled="" name="name" value="<?php echo e(Login()->name ?? ''); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled="" value="<?php echo e(Login()->mobile ?? ''); ?>" class="form-control">
                        </div>
            ...
            <div class="row g-2">
                <div class="col-6">
                    <div class="login_registerWrap metrics_inBox">
                        <h3 class="login_top_title"><img src="<?php echo e(asset('public/frontend/img/metrics-in1.webp')); ?>" class="metrics-in1"
                                alt=""> Games Played</h3>
                        <div class="login_form_box">
...
<script type="text/javascript">
    ...
    $('body').on("click",".userSave",function(){
        ...
        if(name){
            ...
            $('.loader-wrapper').show();
            $.ajax({
                url: '<?php echo e(route("auth.userProfileUpdate")); ?>',
                type: 'POST',
    ...
    $("body").on("change", "#uploadinput1", function () {
        ...
        $('.loader-wrapper').show();
        $.ajax({
            url: '<?php echo e(route("auth.profileImageRequests")); ?>',
            type: 'POST',
            data: form_data,
            processData: false,
            contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/frontend/users/profile.blade.php ENDPATH**/ ?>