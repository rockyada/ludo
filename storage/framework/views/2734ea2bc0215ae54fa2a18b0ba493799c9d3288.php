            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.FAQ_SETTING.FAQ_SETTINGS_TITLE')); ?>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="<?php echo e(route($model.'.create')); ?>" class="btn btn-primary"> <?php echo e(trans("Add New ")); ?> <?php echo e(Config('constants.FAQ_SETTING.FAQ_SETTING_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tbody id="powerwidgets">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href="<?php echo e(route('faq-sub-category.index', [base64_encode($result->id)])); ?>"
                                                            class="btn btn-icon btn-light btn-hover-primary btn-sm"
                                                            data-toggle="tooltip" data-placement="top"
                                                            data-container="body" data-boundary="window"
                                                            title="" data-original-title="Faq Category">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Project\resources\views/admin/faq-category/index.blade.php ENDPATH**/ ?>