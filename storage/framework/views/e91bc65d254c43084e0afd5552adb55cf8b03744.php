            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.PENDING_KYC.PENDING_KYC_TITLES')); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        <a href="<?php echo e(route($model.'.status',[base64_encode($result->id),1])); ?>">
                                                            <span class="label label-lg label-light-success label-inline">
                                                                Approved
                                                            </span>
                                                        </a>
                                                        <a href="<?php echo e(route($model.'.status',[base64_encode($result->id),0])); ?>">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/kyc-pending/index.blade.php ENDPATH**/ ?>