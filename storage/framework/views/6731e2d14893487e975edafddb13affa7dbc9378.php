            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Add New  <?php echo e(Config('constants.FAQ_SETTING.FAQ_SETTING_TITLE')); ?> </h5>
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-muted">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route($model.'.index')); ?>" class="text-muted">  <?php echo e(Config('constants.FAQ_SETTING.FAQ_SETTINGS_TITLE')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('data.'.$language->id.'.title') ?? ''); ?>">
                                                    ...
                                                    <?php else: ?>
                                                    <label for="<?php echo e($language->id); ?>.title">Title</label><span class="text-danger"> </span>
                                                    <input type="text" name="data[<?php echo e($language->id); ?>][title]" class="form-control form-control-solid form-control-lg" value="<?php echo e(old('data.'.$language->id.'.title') ?? ''); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Project\resources\views/admin/faq-category/add.blade.php ENDPATH**/ ?>