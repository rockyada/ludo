            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit <?php echo e(Config('constants.PRODUCT_VARIANT.PRODUCT_VARIANT_TITLE')); ?> </h5>
                    </h5>
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route($model.'.index',base64_encode($variant->product_id))); ?>" class="text-muted"> <?php echo e(Config('constants.PRODUCT_VARIANT.PRODUCT_VARIANTS_TITLE')); ?> </h5>
                            </a>
                        </li>
                    </ul>
                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('data.'.$language->id.'.name') ?? @$multiLanguage[$language->id]['name']); ?>">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        <lable>Price </lable>
                                        <input type="number" name="price" value="<?php echo e($variant->price); ?>"  class="form-control form-control-solid form-control-lg">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/keasybuy/web/keasybuypanel.dev.obdemo.com/public_html/resources/views/admin/product-variant/edit.blade.php ENDPATH**/ ?>