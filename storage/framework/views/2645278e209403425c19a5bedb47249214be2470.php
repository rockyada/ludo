            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.WITHDAW_REQUEST.WITHDAW_REQUEST_TITLE')); ?>
                                            ...
                                            <div class="row mb-6">
                                                <div class="col-lg-3  mb-lg-5 mb-6">
                                                    ...
                                                    <select name="status" class="form-control select2init"
                                                        value="<?php echo e($searchVariable['status'] ?? ''); ?>">
                                                        <option value="">All</option>
                                                        <option value="success"
                                                            <?php echo e(isset($searchVariable['status']) && $searchVariable['status'] == "success" ? 'selected' : ''); ?>>
                                                            Success</option>
                                                        <option value="process"
                                                            <?php echo e(isset($searchVariable['status']) && $searchVariable['status'] == "process" ? 'selected' : ''); ?>>
                                                            Process</option>
                                                        <option value="reject"
                                                            <?php echo e(isset($searchVariable['status']) && $searchVariable['status'] == "reject" ? 'selected' : ''); ?>>
                                                            Reject</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="<?php echo e((($sortBy == 'amount' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'amount' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <a href="<?php echo e(route($model.'.index',array( 'sortBy' => 'amount',
                                                    'order' => ($sortBy == 'amount' && $order == 'desc') ? 'asc' : 'desc',  
                                                    $query_string))); ?>">Amount</a>
                                                    </th>
                                                    <th class="<?php echo e((($sortBy == 'get_amount_via' && $order == 'des') ? 'sorting_desc' : (($sortBy == 'get_amount_via' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <a href="<?php echo e(route($model.'.index',array( 'sortBy' => 'get_amount_via',
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">#<?php echo e($result->id ?? ''); ?>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            <?php echo e($result->get_amount_via ?? ''); ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php elseif($result->status == "process"): ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/withdraw-request/index.blade.php ENDPATH**/ ?>