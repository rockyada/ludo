    ...
    <div class="landing_new_block">
        <div class="login_registerWrap ">
            ...
            <form action="" method="post" class="login_form_box">
               ...
               <div class="row">
                   <div class="col-lg-12">
                    <a href="<?php echo e(route('users.login')); ?>" class="change-numberBtn">
                    ...
                    <div class="otpRow otp_verification">
                      ...
                      <div class="resend_box">
                        <a href="<?php echo e(route('users.resendOtp',[$token])); ?>" class="resend-btn ResendButton">Resend OTP</a>
...
$('.ResendButton').hide();
var countDownDate = new Date("<?php echo e(Session()->get('timer')); ?>").getTime();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/frontend/users/user-verify.blade.php ENDPATH**/ ?>