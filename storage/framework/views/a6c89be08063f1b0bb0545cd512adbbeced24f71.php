...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route($model.'.index')); ?>" class="text-muted"> <?php echo e(Config('constants.PRODUCT.PRODUCTS_TITLE')); ?> </h5>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="d-flex flex-column-fluid">
        <div class=" container ">
            <form action="<?php echo e(route($model.'.update',base64_encode($catDetails->id))); ?>" method="POST" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    <?php if($i == 1): ?>
                                                    <label for="<?php echo e($language->id); ?>.name">Product Name</label><span class="text-danger"> * </span>
                        ...
                        <label for="<?php echo e($language->id); ?>.name">Product Images</label><span class="text-danger"> * </span>
                            <div class="form-group" id="dropBox">
                                ...
                                <div id="gallery">
                                    ...
                                    <?php $imageName = explode("product-image/",$image['system_origin_image_path']); ?>
                                    <div class="imageBox">
                                        <img src="<?php echo e($image['system_thumbnail_image_path']?$image['system_thumbnail_image_path']:$image['origin_image']); ?>">
                                        <a href="javascript:void(0)" data-image="<?php echo e($image['system_thumbnail_image_path']); ?>" data-type-image="<?php echo e($image['id'] ?? ''); ?>" class="imageDelete">
...
<script type="text/javascript">
                ...
                $.each(data, function(key, val) {
                    ...
                    if (result[0] == 'image') {
                        var html = `<div class="imageBox">
                                        ...
                                        <img src="<?php echo e(Config('constants.PRODUCT_IMAGE_PATH')); ?>/${val.image}">
    ...
    $('body').on('click', '.imageDelete', function() {
        ...
        var path = 'PRODUCT_IMAGE_ROOT_PATH';
        Swal.fire({
            title: "Are you sure?",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/keasybuy/web/keasybuypanel.dev.obdemo.com/public_html/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>