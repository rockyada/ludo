            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.CURRENCY.CURRENCY_TITLE')); ?>
                                        ...
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <input type="text" class="form-control" name="code" placeholder="Currency" value="<?php echo e($searchVariable['code'] ?? ''); ?>">
                                                </div>
                                                 <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <thead>
                                                ...
                                                <th>Image</th>
                                                    <th class="<?php echo e((($sortBy == 'code' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'code' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'code',
													'order' => ($sortBy == 'code' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>"> Currency</a>
                                                    </th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(url(Config::get('constants.CURRENCY_IMAGE_ROOT_PATH') . $result->image)); ?>"><img height="50" width="50" src="<?php echo e(url(Config::get('constants.CURRENCY_IMAGE_ROOT_PATH') . $result->image)); ?>" /></a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\Project\resources\views/admin/currency/index.blade.php ENDPATH**/ ?>