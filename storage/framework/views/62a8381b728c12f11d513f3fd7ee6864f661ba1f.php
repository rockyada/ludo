...
<head>
    ...
    <link href="<?php echo e(asset('public/admin/css/datatables.bundle.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo e(asset('public/admin/js/intl-tel-input-master/build/css/intlTelInput.css')); ?>" rel="stylesheet" type="text/css" />
  
    <script src="<?php echo e(asset('public/admin/js/intl-tel-input-master/build/js/intlTelInput-jquery.min.js')); ?>"></script>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="loader-wrapper" style="display: none;">
        <div class="loader">
            <img src="<?php echo e(asset('public/admin/img/logo.png')); ?>" alt="">
        </div>
    </div>
    <!-- loader  -->
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
        <a href="<?php echo e(route('adminpnlx')); ?>">
            <img alt="Logo" style="height:50px;"  src="<?php echo e(asset('public/admin/img/logo-white.png')); ?>" />
        </a>
...
</html><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/layouts/layout.blade.php ENDPATH**/ ?>