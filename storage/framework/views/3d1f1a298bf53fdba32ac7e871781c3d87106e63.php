...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit <?php echo e(Config('constants.GAMES.GAMES_TITLE')); ?></h5>
    ...
    <div class="d-flex flex-column-fluid">
        <div class=" container ">
            <form action="<?php echo e(route($model.'.update',[$game_id])); ?>" method="post" class="mws-form" autocomplete="off" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($gamesInfo->game_name ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($gamesInfo->api_url ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php if(@$gamesInfo->game_image): ?>
                                          <div class="text-dark-75 mb-1 font-size-lg">
                                             <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(Config('constants.GAMES_IMAGE_PATH').$gamesInfo->game_image ?? ''); ?>"><img height="50" width="50" src="<?php echo e(Config('constants.GAMES_IMAGE_PATH').$gamesInfo->game_image ?? ''); ?>"></a>
                                         </div>
                                         <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/games/edit.blade.php ENDPATH**/ ?>