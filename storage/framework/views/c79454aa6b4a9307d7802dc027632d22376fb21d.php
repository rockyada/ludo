                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="list_bannr_img">
                            <img src="<?php echo e(asset('public/frontend/img/blog-banner.jpg')); ?>" alt="">
                        </div>
                        </div>
                        <div class="swiper-slide">
                        <div class="list_bannr_img">
                        ...
                        <a href="ludo-contest.html" class="convestCArd">
                            <div class="play_winning_name">
                                <div class="play_winning02">
                                    ...
                                    <img src="<?php echo e(asset('public/frontend/img/avatar-img.svg')); ?>" alt="">
...
<?php echo $__env->make('frontend.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/frontend/game/battle-listing.blade.php ENDPATH**/ ?>