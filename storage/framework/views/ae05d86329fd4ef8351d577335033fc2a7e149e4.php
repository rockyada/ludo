                                    ...
                                    <div class="table-responsive">
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg"><?php echo e($result->battle_id ?? ''); ?>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg"><?php echo e($result->entry_fee ?? ''); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg"><?php echo e($result->prize ?? ''); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/running-battles/index.blade.php ENDPATH**/ ?>