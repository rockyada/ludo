            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <div class="mobile_logo">
                        <h3 class="ludo_side_title"><?php echo e(Config('constants.SITE_TITLE')); ?></h3>
                    </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <?php if(!Login()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('users.signup')); ?>">
                                <div>
                                    <img src="https://ludoplayers.com/static/media/play.2f22f88bac8acca85f6a.webp" height="36px" alt="play">
                                    Register
                                </div>
                        ...
                        <?php if(Login()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.wallet')); ?>">
                                <div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.history')); ?>">
                                <div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.profile')); ?>">
                                <div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.referEarn')); ?>">
                                <div>
                        ...
                        <?php endif; ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.support')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('auth.lagalTerms')); ?>">
                                <img src="https://ludoplayers.com/static/media/liveChatOffcanvas.4db8ac024d1cc6d424a3.webp"
                                    height="36px" alt="play">
                                Legal Terms
                            </a>
...
</header><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/frontend/element/header.blade.php ENDPATH**/ ?>