                                    ...
                                    <div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
                                        <div>
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-3  mb-lg-5 mb-6">
                                                    <label>Source</label>
                                                    <select name="source" class="form-control select2init">
                                                        <option value="">All</option>
                                                        <?php $__currentLoopData = Config('constants.SOURCE'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keys => $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($keys ?? ''); ?>" <?php echo e(isset($searchVariable['source']) && $searchVariable['source'] == $keys ? 'selected' : ''); ?>><?php echo e($source ?? ''); ?></option>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    <th class="<?php echo e((($sortBy == 'is_featured_homepage' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'is_featured_homepage' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'is_featured_homepage',
													'order' => ($sortBy == 'is_featured_homepage' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>">Featured Image</a>
                                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10px">
                                                        <div class="text-dark-75 mb-1 font-size-lg ">
                                                            <input type="checkbox" class="is_featured_homepage" <?php echo e($result->is_featured_homepage == '1' ? 'checked' : ''); ?> data-id="<?php echo e($result->id ?? ''); ?>">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            <?php echo e($result->platform_name ? ucfirst(str_replace("_"," ",$result->platform_name)) : ''); ?>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href="<?php echo e(route($model.'.categoryLavelTwoIndex',base64_encode($result->id))); ?>" class="btn-success btn-sm">
                                                            Category Level 2</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    $('.is_featured_homepage').click(function(){
        var featuredStatus =  $(this).is(":checked") == true ? 1 : 0;
        var categoryId     =  $(this).data('id');
        // $('.loader-wrapper').show();
        $.ajax({
            type: "POST",
            url:  "<?php echo e(route($model.'.featuredImage',[])); ?>",
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/keasybuy/web/keasybuypanel.dev.obdemo.com/public_html/resources/views/admin/category/index.blade.php ENDPATH**/ ?>