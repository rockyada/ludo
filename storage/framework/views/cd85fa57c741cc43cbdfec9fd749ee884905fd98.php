            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.GAMES.GAMES_TITLES')); ?>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href='<?php echo e(route("$model.create")); ?>' class="btn btn-primary">Add New <?php echo e(Config('constants.GAMES.GAMES_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    <th>Image</th>
                                                    <th class="<?php echo e((($sortBy == 'game_id' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'game_id' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                    <a href="<?php echo e(route($model.'.index',array( 'sortBy' => 'game_id',
                                                    'order' => ($sortBy == 'game_id' && $order == 'desc') ? 'asc' : 'desc',    
                                                    $query_string))); ?>">Game Id</a>
                                                    </th>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                             <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(Config('constants.GAMES_IMAGE_PATH').$result->game_image ?? ''); ?>"><img height="50" width="50" src="<?php echo e(Config('constants.GAMES_IMAGE_PATH').$result->game_image ?? ''); ?>"></a>
                                                         </div>
                                                         <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            <?php echo e($result->game_id ?? ''); ?>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            <?php echo e($result->game_name ?? ''); ?>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        <?php if($result->status == 1): ?>
                                                        <a title="Click To Deactivated" href='<?php echo e(route($model.".status",array($result->id,0))); ?>' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Deactivate">
                                                        ...
                                                        <?php else: ?>
                                                        <a title="Click To Activate" href='<?php echo e(route($model.".status",array($result->id,1))); ?>' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Activate">
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/admin/games/index.blade.php ENDPATH**/ ?>