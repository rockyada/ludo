            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.SERVICE_FLOW.SERVICE_FLOW_TITLES')); ?>
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <a href="<?php echo e(route($model.'.create')); ?>" class="btn btn-primary"> <?php echo e(trans("Add New ")); ?>
                                        ...
                                        <?php echo e(Config('constants.SERVICE_FLOW.SERVICE_FLOW_TITLE')); ?> </a>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
                                                            ...
                                                            <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo e(url(Config('constants.SERVICE_FLOW_IMAGE_ROOT_PATH') . $result->image)); ?>">
                                                                <img width="70px" height="70" src="<?php echo e(url(Config('constants.SERVICE_FLOW_IMAGE_ROOT_PATH') . $result->image)); ?>" />
                                                            </a>
                                                            <?php endif; ?>
                                                        </div>
                                                    </td>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/keasybuy/web/keasybuypanel.dev.obdemo.com/public_html/resources/views/admin/service-flow/index.blade.php ENDPATH**/ ?>