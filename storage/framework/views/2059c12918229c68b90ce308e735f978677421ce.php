        ...
        <div class="login_registerWrap box-shadow-none">
            ...
            <form class="login_form_box">
               <div class="img_boxRefer">
                <img src="<?php echo e(asset('public/frontend/img/refer.webp')); ?>" alt="">
               </div>
...
<?php echo $__env->make('frontend.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ludo_king\resources\views/frontend/users/refer-earn.blade.php ENDPATH**/ ?>