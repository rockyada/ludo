            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        <?php echo e(Config('constants.PRODUCT_VARIANT.PRODUCT_VARIANTS_TITLE')); ?>
                                            ...
                                            <thead>
                                                <tr class="text-uppercase">
                                                    <th class="<?php echo e((($sortBy == 'name' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'name' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'name','ensetid'=>$ensetid,
													'order' => ($sortBy == 'name' && $order == 'desc') ? 'asc' : 'desc',	
													$query_string))); ?>"> Name</a>
                                                    </th>
                                                    <th class="<?php echo e((($sortBy == 'price' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'price' && $order == 'asc') ? 'sorting_asc' : 'sorting'))); ?>">
                                                        <a href="<?php echo e(route($model.'.index',array(	'sortBy' => 'price', 'ensetid'=>$ensetid,
                                            ...
                                            <tbody id="powerwidgets">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-2">
                                                        ...
                                                        <a href="<?php echo e(route('product-variant-value.index',base64_encode($result->id))); ?>" class="btn btn-primary btn-hover-default btn-sm">
                                                             Variant Value
                                                        </a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/keasybuy/web/keasybuypanel.dev.obdemo.com/public_html/resources/views/admin/product-variant/index.blade.php ENDPATH**/ ?>