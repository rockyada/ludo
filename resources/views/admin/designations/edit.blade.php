			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						Edit {{Config('constants.DESIGNATION.DESIGNATION_TITLE')}} </h5>
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						<li class="breadcrumb-item">
							<a href="{{ route('dashboard')}}" class="text-muted">Dashboard</a>
						</li>
						<li class="breadcrumb-item">
							<a href="{{route('designations.index')}}" class="text-muted">{{Config('constants.DESIGNATION.DESIGNATIONS_TITLE')}}</a>
						</li>
					</ul>
				</div>
			</div>
												...
												<div class="">
													...
													<div class="row">
														...
														<div class="col-auto mb-5">
															<label class="checkbox">
																<input type="checkbox" name="data[{{$counter}}][module][{{$module_counter}}][value]" value=1 id="{{$aclModule->id}}" class="children child.{{$aclModule->id}}" {{ ($module->active == 1) ? 'checked' : '' }}>
