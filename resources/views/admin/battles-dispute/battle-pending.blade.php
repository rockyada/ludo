         ...
         <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
               <h5 class="text-dark font-weight-bold my-1 mr-5">
                  View {{Config('constants.BATTLES_DISPUTE.BATTLES_DISPUTE_TITLE')}}
               </h5>
               <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                     <a href="{{ route($model.'.index')}}" class="text-muted">    {{Config('constants.BATTLES_DISPUTE.BATTLES_DISPUTE_TITLE')}}</a>
                  </li>
               </ul>
            </div>
         </div>
                     ...
                     <div class="form-group row my-2">
                        ...
                        <div class="col-12">
                           <div class="form-group row my-2">
                              ...
                              <div class="col-8 text-center">
                                 <span class="form-control-plaintext font-weight-bolder">
                                    {{ @$battlesInfo->accept_request_time ? date(config("Reading.date_format")." h:i:s",strtotime($battlesInfo->accept_request_time)) : "Not Avaliable"}}
                                 </span>
                              </div>
                           </div>
                            <hr>
                        ...
                        <div class="col-12">
                          <form action="{{route($model.'.updateResult',base64_encode($battlesInfo->id))}}" method="post">
                            @csrf
                            <div class="form-group row my-2">
                              ...
                              <div class="col-8 text-center">
                                  <select name="winner" id="" class="form-control" required>
                                    ...
                                    <option value="{{ $battlesInfo->creator_id }}">{{ $creator_details->vplay_id }}</option>
                                    <option value="{{ $battlesInfo->joiner_id }}">{{ $joiner_details->vplay_id }}</option>
                                  </select>
                              </div>
                            </div>
                            <div class="form-group row my-2 mt-5">
                              ...
                              <div class="col-8">
                                ...
                                <a href="{{route($model.'.cancelBattle',base64_encode($battlesInfo->id))}}" class="btn btn-danger">Cancel The Battle</a>
                              </div>
                            </div>
                          </form>
                        </div>
