            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{Config('constants.BATTLES_DISPUTE.BATTLES_DISPUTE_TITLE')}}
                    </h5>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th class="{{(($sortBy == 'admin_commision' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'admin_commision' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route($model.'.index',array( 'sortBy' => 'admin_commision',
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img width="20px" src="{{Config('constants.WEBSITE_URL').'public/admin/img/global-rupeeIcon.png'}}">&nbsp;&nbsp;₹ {{ $result->admin_commision ?? '' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        @if($result->creator_result=='cancel' && $result->joiner_result=='cancel')
                                                          <a href="{{route($model.'.show',base64_encode($result->id))}}" class="btn btn-warning">Cancelled</a>
                                                          @elseif($result->creator_result=='lost' && $result->joiner_result=='lost')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                           @elseif($result->creator_result=='lost' && $result->joiner_result=='cancel')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                          @elseif($result->joiner_result=='win' && $result->creator_result=='cancel')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                           @elseif($result->joiner_result=='lost' && $result->creator_result=='cancel')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                          @elseif($result->creator_result=='win' && $result->joiner_result=='cancel')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                          @elseif($result->creator_result != $result->joiner_result)
                                                          <a href="{{route($model.'.show',base64_encode($result->id))}}" class="btn btn-success">Approved</a>
                                                          @elseif($result->creator_result=='win' && $result->joiner_result=='win')
                                                          <a href="{{route($model.'.battlePending',base64_encode($result->id))}}" class="btn btn-danger">Pending</a>
                                                        @endif
