                                    ...
                                    <div class="table-responsive">
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">{{ $result->battle_id ?? '' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">{{ $result->entry_fee ?? '' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">{{ $result->prize ?? '' }}
                                                        </div>
                                                    </td>
                                                    <td>
