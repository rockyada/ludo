            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{Config('constants.PAYMENTS.PAYMENTS_TITLES')}}
                    </h5>
                                        ...
                                        <table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <a href="{{route($model.'.index',array( 'sortBy' => 'order_id',
                                                    'order' => ($sortBy == 'order_id' && $order == 'desc') ? 'asc' : 'desc',  
                                                    $query_string))}}">Order id</a>
                                                    </th>
                                                    <th>User Id</th>
                                                    <th>Mobile</th>                                                    <th class="{{(($sortBy == 'amount' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'amount' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">#{{ $result->order_id ?? '' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="label {{$result->status != 'FAILED' ? 'label-lg label-light-success'  : 'label-light-danger'}} label-inline">{{$result->status ?? ''}}</span>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark-75 mb-1 font-size-lg">
