											...
											<tbody>
												...
												<tr>
													...
													<td class="text-right pr-2">
														...
														<!-- <a href="{{route($modelName.'.destroy',base64_encode($result->id))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="" data-original-title="Delete">                            
