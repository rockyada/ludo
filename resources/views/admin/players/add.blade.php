            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Add New {{Config('constants.PLAYERS.PLAYERS_TITLE')}}</h5>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" onKeyPress="if(this.value.length==10) return false;" min="0" name="mobile" class="form-control form-control-solid form-control-lg  @error('mobile') is-invalid @enderror" value="{{old('mobile')}}">
