            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Add New {{Config('constants.GAMES.GAMES_TITLE')}}</h5>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="game_name" class="form-control form-control-solid form-control-lg  @error('game_name') is-invalid @enderror" value="{{old('game_name')}}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label>API URL</label>
                                            <input type="url" name="api_url" class="form-control form-control-solid form-control-lg  @error('api_url') is-invalid @enderror" value="{{old('api_url')}}">
